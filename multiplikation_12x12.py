...
#usage in terminal: python3 multiplikation_12x12.py > math_sheet.txt
...
for i in range(64):
	...
	r2 = n3 * n4
	r3 = n5 * n6
	print(f"{n1:>2} * {n2:>2} =_|_|_|_|_|_|_{r1:>3}  {n3:>2} * {n4:>2} =_|_|_|_|_|_|_{r2:>3}  {n5:>2} * {n6:>2} =_|_|_|_|_|_|_{r3:>3}")
